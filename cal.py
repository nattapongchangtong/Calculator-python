...
m = Tk()
m.title("Calculator by Nattapong")
...
Button(m, text="clear", command=clear).grid(row=1, column=0, columnspan=2, sticky="news")
...
Button(m, text="0", command=lambda: press("0")).grid(row=5, column=0,columnspan=1)
